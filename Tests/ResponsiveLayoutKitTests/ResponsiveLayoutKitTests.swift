...
struct ResponsiveLayoutPrecedenceTests {
    ...
    func containerFallback() {
        #expect(
            resolvedResponsiveLayout(override: nil, sceneLayout: nil, horizontalSizeClass: .regular) == .tablet
        )
        #expect(
            resolvedResponsiveLayout(override: nil, sceneLayout: nil, horizontalSizeClass: .compact) == .phone
        )
        #expect(
    ...
    func overrideWinsOverContainer() {
        #expect(
            resolvedResponsiveLayout(override: .tablet, sceneLayout: nil, horizontalSizeClass: .compact) == .tablet
        )
    }
    ...
    func overrideWinsOverScene() {
        #expect(
            resolvedResponsiveLayout(override: .phone, sceneLayout: .tablet, horizontalSizeClass: .regular) == .phone
        )
    }
    ...
    func sceneWinsOverContainer() {
        #expect(
            resolvedResponsiveLayout(override: nil, sceneLayout: .tablet, horizontalSizeClass: .compact) == .tablet
        )
    }
}
