...
- `Demo/` standalone Xcode app (XcodeGen-generated from `Demo/project.yml`) demonstrating every API. References the package as a local dependency; not part of any product and not shipped via SwiftPM.
